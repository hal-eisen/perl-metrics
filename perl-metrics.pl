...
# $Id: perl-metrics.pl,v 1.7 2001/07/02 20:44:47 eisen Exp $

# Copyright (C) 2000,2001 Hal J Eisen (eisen@dunhackin.org)
...
use constant non_subroutine_warning_threshold    => 50;
use constant subroutine_length_warning_threshold => 65;
use constant code_to_comment_threshold           => 4;
